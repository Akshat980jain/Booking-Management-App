...
import com.bms.app.data.repository.ConfigRepositoryImpl;
import com.bms.app.data.repository.LoyaltyRepositoryImpl;
import com.bms.app.data.repository.NotificationRepositoryImpl;
...
import com.bms.app.di.NetworkModule_ProvideSupabaseFunctionsFactory;
import com.bms.app.di.NetworkModule_ProvideSupabasePostgrestFactory;
import com.bms.app.di.NetworkModule_ProvideSupabaseRealtimeFactory;
...
import com.bms.app.ui.config.SystemConfigViewModel_HiltModules_KeyModule_ProvideFactory;
...
import com.bms.app.ui.dashboard.UserDashboardViewModel_HiltModules_KeyModule_ProvideFactory;
...
import com.bms.app.ui.user.ProviderDetailViewModel;
import com.bms.app.ui.user.ProviderDetailViewModel_HiltModules_KeyModule_ProvideFactory;
import com.bms.app.ui.user.ReviewViewModel;
import com.bms.app.ui.user.ReviewViewModel_HiltModules_KeyModule_ProvideFactory;
import com.bms.app.ui.user.RewardsViewModel;
import com.bms.app.ui.user.RewardsViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerBmsApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends BmsApplication_HiltComponents.ViewModelC {
    ...
    private Provider<ProviderDetailViewModel> providerDetailViewModelProvider;
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.providerDetailViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 8);
      ...
      this.supportViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 12);
      this.systemConfigViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 13);
      this.userDashboardViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 14);
      this.userDetailViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 15);
      this.videoCallViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 16);
      this.visibilityViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 17);
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new AdminViewModel(ApplicationContextModule_ProvideApplicationFactory.provideApplication(singletonCImpl.applicationContextModule), singletonCImpl.bindProfileRepositoryProvider.get(), singletonCImpl.appointmentRepositoryImplProvider.get(), singletonCImpl.provideSupabaseAuthProvider.get(), singletonCImpl.provideSupabasePostgrestProvider.get(), singletonCImpl.notificationRepositoryImplProvider.get());
          ...
          case 8: // com.bms.app.ui.user.ProviderDetailViewModel 
          return (T) new ProviderDetailViewModel(singletonCImpl.bindProfileRepositoryProvider.get(), singletonCImpl.reviewRepositoryImplProvider.get(), singletonCImpl.appointmentRepositoryImplProvider.get());

          case 9: // com.bms.app.ui.user.ReviewViewModel 
          return (T) new ReviewViewModel(singletonCImpl.reviewRepositoryImplProvider.get(), singletonCImpl.authRepositoryImplProvider.get());

          case 10: // com.bms.app.ui.user.RewardsViewModel 
          return (T) new RewardsViewModel(singletonCImpl.bindLoyaltyRepositoryProvider.get(), singletonCImpl.provideSupabaseAuthProvider.get());

          case 11: // com.bms.app.ui.settings.viewmodel.SettingsViewModel 
          ...
          case 12: // com.bms.app.ui.chat.SupportViewModel 
          return (T) new SupportViewModel(singletonCImpl.bindProfileRepositoryProvider.get());

          case 13: // com.bms.app.ui.config.SystemConfigViewModel 
          return (T) new SystemConfigViewModel(singletonCImpl.configRepositoryImplProvider.get());

          case 14: // com.bms.app.ui.dashboard.UserDashboardViewModel 
          return (T) new UserDashboardViewModel(ApplicationContextModule_ProvideApplicationFactory.provideApplication(singletonCImpl.applicationContextModule), singletonCImpl.bindProfileRepositoryProvider.get(), singletonCImpl.appointmentRepositoryImplProvider.get(), singletonCImpl.provideSupabaseAuthProvider.get(), singletonCImpl.provideSessionManagerProvider.get(), singletonCImpl.notificationRepositoryImplProvider.get());

          case 15: // com.bms.app.ui.admin.UserDetailViewModel 
          return (T) new UserDetailViewModel(singletonCImpl.bindProfileRepositoryProvider.get());

          case 16: // com.bms.app.ui.video.VideoCallViewModel 
          return (T) new VideoCallViewModel(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.videoRepositoryImplProvider.get(), singletonCImpl.provideSupabaseRealtimeProvider.get());

          case 17: // com.bms.app.ui.settings.viewmodel.VisibilityViewModel 
  ...
  private static final class SingletonCImpl extends BmsApplication_HiltComponents.SingletonC {
    ...
    private Provider<Functions> provideSupabaseFunctionsProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.reviewRepositoryImplProvider = DoubleCheck.provider(new SwitchingProvider<ReviewRepositoryImpl>(singletonCImpl, 11));
      this.loyaltyRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 12);
      this.bindLoyaltyRepositoryProvider = DoubleCheck.provider((Provider) loyaltyRepositoryImplProvider);
      this.provideSessionManagerProvider2 = DoubleCheck.provider(new SwitchingProvider<SessionManager>(singletonCImpl, 13));
      this.configRepositoryImplProvider = DoubleCheck.provider(new SwitchingProvider<ConfigRepositoryImpl>(singletonCImpl, 14));
      this.provideSupabaseFunctionsProvider = DoubleCheck.provider(new SwitchingProvider<Functions>(singletonCImpl, 16));
      this.videoRepositoryImplProvider = DoubleCheck.provider(new SwitchingProvider<VideoRepositoryImpl>(singletonCImpl, 15));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 9: // com.bms.app.data.repository.AvailabilityRepositoryImpl 
          return (T) new AvailabilityRepositoryImpl(singletonCImpl.provideSupabasePostgrestProvider.get());

          case 10: // com.bms.app.data.repository.ChatRepositoryImpl 
          return (T) new ChatRepositoryImpl(singletonCImpl.provideSupabaseAuthProvider.get(), singletonCImpl.provideSupabasePostgrestProvider.get(), singletonCImpl.provideSupabaseRealtimeProvider.get());

          case 11: // com.bms.app.data.repository.ReviewRepositoryImpl 
          return (T) new ReviewRepositoryImpl(singletonCImpl.provideSupabasePostgrestProvider.get());

          case 12: // com.bms.app.data.repository.LoyaltyRepositoryImpl 
          return (T) new LoyaltyRepositoryImpl(singletonCImpl.provideSupabasePostgrestProvider.get());

          case 13: // com.bms.app.data.local.SessionManager 
          ...
          case 14: // com.bms.app.data.repository.ConfigRepositoryImpl 
          return (T) new ConfigRepositoryImpl(singletonCImpl.provideSupabasePostgrestProvider.get());

          case 15: // com.bms.app.data.repository.VideoRepositoryImpl 
          return (T) new VideoRepositoryImpl(singletonCImpl.provideSupabasePostgrestProvider.get(), singletonCImpl.provideSupabaseFunctionsProvider.get());

          case 16: // io.github.jan.supabase.functions.Functions 
          return (T) NetworkModule_ProvideSupabaseFunctionsFactory.provideSupabaseFunctions(singletonCImpl.provideSupabaseClientProvider.get());
