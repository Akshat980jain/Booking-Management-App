...
public abstract class RepositoryModule {
    ...
    @javax.inject.Singleton()
    @org.jetbrains.annotations.NotNull()
    public abstract com.bms.app.domain.repository.ConfigRepository bindConfigRepository(@org.jetbrains.annotations.NotNull()
    com.bms.app.data.repository.ConfigRepositoryImpl configRepositoryImpl);
    
    @dagger.Binds()
    @javax.inject.Singleton()
    @org.jetbrains.annotations.NotNull()
    public abstract com.bms.app.domain.repository.VideoRepository bindVideoRepository(@org.jetbrains.annotations.NotNull()
    com.bms.app.data.repository.VideoRepositoryImpl videoRepositoryImpl);
}